...
var _RouteToUniversity = _interopRequireDefault(require("../models/RouteToUniversity"));
var _routeInformation = require("../libs/routeInformation");
var _vehicleService = require("../libs/vehicleService");
var _RoutesPropertiesToUniversity = _interopRequireDefault(require("../models/RoutesPropertiesToUniversity"));
...
var createRoute = exports.createRoute = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var token, _req$body, origin, city, description, departureDate, departureTime, availableSeats, vehicleId, seats, newRoute, savedRoute;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          token = req.headers.authorization;
          _req$body = req.body, origin = _req$body.origin, city = _req$body.city, description = _req$body.description, departureDate = _req$body.departureDate, departureTime = _req$body.departureTime, availableSeats = _req$body.availableSeats, vehicleId = _req$body.vehicleId;
          _context.next = 5;
        ...
        case 8:
          newRoute = new _RouteToUniversity["default"]({
            origin: origin,
            city: city,
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          token = req.headers.authorization;
          _context2.next = 4;
          return _RouteToUniversity["default"].find();
        case 4:
      ...
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
            var city, routesInCity, numberRoutes, numberDrivers, numberSeats, origins, routeProperties;
            return _regeneratorRuntime().wrap(function _loop$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  origins = routesInCity.map(function (route) {
                    return route.origin;
                  });
                  routeProperties = new _RoutesPropertiesToUniversity["default"](city, numberRoutes, numberDrivers, numberSeats, origins);
