...
_callback_api["default"].connect(rabbitSettings, function (error0, connection) {
  ...
  connection.createChannel(function (error1, ch) {
    ...
    channel = ch;
    channel.assertQueue(_config.QUEUE, {
      durable: false
    });
  });
});
var sendToQueue = exports.sendToQueue = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(queue, message) {
  ...
  return function sendToQueue(_x, _x2) {
